...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{img/ejercicio_04_naive_closest.png}
	\caption{Implementación de la función \textit{closest\_point\_force\_brute}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{img/ejercicio_05_naive_closest.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{img/ejercicio_06_naive_closest.png}
	\caption{Evaluación de datos con la función \textit{naive\_closest}}
